        ...
        <div className="feed-container">
          <div className="card">
            <div className="card-header">
              <div className="user-info">
                ...
                <div className="user-details">
                  ...
                  <p className="project-title">Project: Fitness Journey</p>
                </div>
              </div>
            ...
            <div className="card-content">
              ...
              <p className="caption">{formatCaptionWithHashtags('Just completed a 5k run! #fitness #achievement')}</p>
            </div>
            <div className="card-actions">
              ...
              <button className="action-btn comment-btn" aria-label="Comment on post">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="card">
            <div className="card-header">
              <div className="user-info">
                ...
                <div className="user-details">
                  <div className="post-details">
                    <h4 className="username">Sarah Chen</h4>
                    <span className="timestamp">4 hours ago</span>
                  </div>
                  <p className="project-title">Project: Web Design Course</p>
                </div>
              </div>
              <button className="options-btn" aria-label="More options">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="card-content">
              <img src="https://images.unsplash.com/photo-1561070791-2526d30994b5"
                alt="Post Image" className="post-image" />
              <p className="caption">{formatCaptionWithHashtags('Finished my web design course! Ready to build amazing projects 🚀 #design #learning')}</p>
            </div>
            <div className="card-actions">
              <button className="action-btn like-btn" aria-label="Like post">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="card">
            <div className="card-header">
              <div className="user-info">
                ...
                <div className="user-details">
                  <div className="post-details">
                    <h4 className="username">Alex Rivera</h4>
                    <span className="timestamp">6 hours ago</span>
                  </div>
                  <p className="project-title">Project: AI Integration</p>
                </div>
              </div>
              <button className="options-btn" aria-label="More options">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="card-content">
              <img src="https://images.unsplash.com/photo-1517694712202-14dd9538aa97"
                alt="Post Image" className="post-image" />
              <p className="caption">{formatCaptionWithHashtags('Implemented a machine learning model today! Results are promising 📊 #ai #ml #python #dbms')}</p>
            </div>
            <div className="card-actions">
              <button className="action-btn like-btn" aria-label="Like post">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
